...
<template>
  <header>
    <svg preserveAspectRatio="xMidYMid meet" data-bbox="0 0.02 1242.09 287.41" viewBox="0 0.02 1242.09 287.41"
      xmlns="http://www.w3.org/2000/svg" data-type="shape" role="presentation" aria-hidden="true" aria-label=""
      style="width: 500; height: auto; margin-right: 75px;">
      <g>
    ...
    <div class="wrapper">
      ...
      <nav>
        <RouterLink to="/">Pág. Inicial</RouterLink>
        <RouterLink to="/dashboard">Dados</RouterLink>
      </nav>
    </div>
  </header>
  <main>
